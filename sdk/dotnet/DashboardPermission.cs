...
namespace Pulumi.Grafana
{
    ...
    public partial class DashboardPermission : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class DashboardPermissionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// ID of the dashboard to apply permissions to.
        /// </summary>
    ...
    public sealed class DashboardPermissionState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// ID of the dashboard to apply permissions to.
        /// </summary>
