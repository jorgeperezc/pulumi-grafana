...
class TeamArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] members: A list of email addresses corresponding to users who should be given membership to the team. Note: users specified here
